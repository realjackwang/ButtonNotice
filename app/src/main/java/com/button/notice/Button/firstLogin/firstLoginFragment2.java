...
public class firstLoginFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable
        ...
        View view = inflater.inflate(R.layout.fragment_firstlogin_2, null);
    ...
    public static firstLoginFragment2 newInstance(String content) {
        Bundle args = new Bundle();
        args.putString("ARGS", content);
        firstLoginFragment2 fragment = new firstLoginFragment2();
